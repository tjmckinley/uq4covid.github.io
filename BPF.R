...
## a1, a2, b1, b2: parameters for truncated discrete Gaussian observation process
## a_dis: intercept for MD process (can be nages x nlads matrix)
## b_dis: multiplicative scaling for truncated discrete Gaussian MD process (can be nages x nlads matrix)
## sigma2_lad: the aggregation error for observations at the LTLA level
## sigma2_age_region: the aggregation error for observations at the age/region level
## sigma2_nhsregion: the aggregation error for observations at the NHS region level
## sigma2_age_nhsregion: the aggregation error for observations at the NHS age/region level
...
## outputName: a character denoting a folder name into which to save the trajectories if saving
##             to external files.
