...
## a_dis: intercept for truncated discrete Gaussian MD process (can be nages x nlads matrix)
## b_dis: multiplicative scaling for truncated Gaussian MD process (can be nages x nlads matrix)
## sigma2_age_lad: the aggregation error for observations at the age/LTLA level
